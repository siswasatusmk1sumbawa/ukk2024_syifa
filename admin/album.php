					...
					<div class="card-header">
						<div class="card-body">
							<form action="../config/aksi_album.php" method="POST">
								...
								<textarea class="form_control" name="deskripsi" required></textarea>
						...
						<div class="card-body">
							<table class="table">
								...
								<tbody>
									...
									$sql = mysqli_query($koneksi, "SELECT * FROM album WHERE UserID='$userid'"); //kesalahan tidak teliti dengan nama kolom database, tertulis sebelumnya userid
									while ($data = mysqli_fetch_array($sql)) {
									?>
										<tr>
											<td><?php echo $no++ ?></td>
											<td><?php echo $data['NamaAlbum'] ?></td> <?php //kesalahan yang sama, tidak teliti dengan nama tabel 
																																?>
											<td><?php echo $data['Deskripsi'] ?></td> <?php //kesalahan yang sama, tidak teliti dengan nama tabel 
																																?>
											<td><?php echo $data['TanggalDibuat'] ?></td> <?php //kesalahan yang sama, tidak teliti dengan nama tabel 
																																		?>
											<td>
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																<form action="../config/aksi_album.php" method="POST">
																	...
																	<label class="form-label">Deskripsi</label>
																	<textarea class="form_control" name="deskripsi" required><?php echo $data['Deskripsi'] ?></textarea>
															</div>
